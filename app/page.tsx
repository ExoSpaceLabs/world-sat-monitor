...
function MapSettingsPanel({ basemap, onChange, onClose }: {
  basemap: Basemap;
...
export default function Home() {
  ...
  return <main className="monitor-shell">
    ...
    <section className="viewport">
      <Globe resetKey={resetKey} basemap={basemap} onCameraChange={handleCameraChange} onMapState={handleMapState}/>
      ...
      {settingsOpen && <MapSettingsPanel basemap={basemap} onChange={setBasemap} onClose={() => setSettingsOpen(false)}/>} 
