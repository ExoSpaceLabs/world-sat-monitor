...
function BasemapCredit({basemap}: {basemap: Basemap}) {
  ...
  return <>Land © <a href="https://www.naturalearthdata.com/" target="_blank" rel="noreferrer">Natural Earth</a> · Reference © <a href="https://www.esri.com/" target="_blank" rel="noreferrer">Esri</a></>;
}
...
export function WorldSatMonitor() {
  ...
  const handleThemeWaterColorChange = useCallback((color: string) => { persistMapSettings({themed_water_color: color}); }, [persistMapSettings]);
  const handleThemeLandColorChange = useCallback((color: string) => { persistMapSettings({themed_land_color: color}); }, [persistMapSettings]);
  ...
  return (
    <main className="monitor-shell" data-layer="page">
      ...
      <section className="viewport">
        ...
        <GlobeMap basemap={basemap} followSatellite={followSatellite && selectedPositionReady} resetKey={resetKey} satellite={satellite} themeLandColor={appSettings.map.themed_land_color} themeWaterColor={appSettings.map.themed_water_color} timeResetKey={timeResetKey} timeScale={timeScale} onMapSession={setMapSession} onMapState={setMapState} onOrientationChange={setOrientation} onRotationChange={handleRotationChange}>
        ...
        {mapSettingsOpen && <MapSettingsPanel basemap={basemap} scene={scene} themeLandColor={appSettings.map.themed_land_color} themeWaterColor={appSettings.map.themed_water_color} timeScale={timeScale} onBasemapChange={handleBasemapChange} onDebugChange={handleDebugChange} onEnvironmentChange={handleEnvironmentChange} onShadowOpacityChange={handleShadowOpacityChange} onThemeLandColorChange={handleThemeLandColorChange} onThemeWaterColorChange={handleThemeWaterColorChange} onTimeReset={handleTimeReset} onTimeScaleChange={handleTimeScaleChange} onReset={handleMapSettingsReset} onClose={() => setMapSettingsOpen(false)}/>} 
