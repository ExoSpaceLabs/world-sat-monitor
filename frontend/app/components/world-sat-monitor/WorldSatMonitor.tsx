...
function BasemapCredit({basemap}: {basemap: Basemap}) {
  ...
  return <>Land geometry © <a href="https://maplibre.org/" target="_blank" rel="noreferrer">MapLibre</a> demo tiles · Reference © <a href="https://www.esri.com/" target="_blank" rel="noreferrer">Esri</a></>;
}
  ...
  return (
    <main className="monitor-shell" data-layer="page">
      ...
      <section className="viewport">
        ...
        <GlobeMap basemap={basemap} followSatellite={followSatellite && selectedPositionReady} resetKey={resetKey} satellite={satellite} themeLandColor={appSettings.map.theme_land_color} themeWaterColor={appSettings.map.theme_water_color} timeResetKey={timeResetKey} timeScale={timeScale} onMapSession={setMapSession} onMapState={setMapState} onOrientationChange={setOrientation} onRotationChange={handleRotationChange}>
        ...
        {mapSettingsOpen && <MapSettingsPanel basemap={basemap} scene={scene} themeLandColor={appSettings.map.theme_land_color} themeWaterColor={appSettings.map.theme_water_color} timeScale={timeScale} onBasemapChange={handleBasemapChange} onDebugChange={handleDebugChange} onEnvironmentChange={handleEnvironmentChange} onShadowOpacityChange={handleShadowOpacityChange} onThemeLandColorChange={(theme_land_color) => persistMapSettings({theme_land_color})} onThemeWaterColorChange={(theme_water_color) => persistMapSettings({theme_water_color})} onTimeReset={handleTimeReset} onTimeScaleChange={handleTimeScaleChange} onReset={handleMapSettingsReset} onClose={() => setMapSettingsOpen(false)}/>} 
