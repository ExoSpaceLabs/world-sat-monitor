...
export function WorldSatMonitor() {
  ...
  const handleThemeLandColorChange = useCallback((themed_land_color: string) => { persistMapSettings({themed_land_color}); }, [persistMapSettings]);
  const handleThemeWaterColorChange = useCallback((themed_water_color: string) => { persistMapSettings({themed_water_color}); }, [persistMapSettings]);
